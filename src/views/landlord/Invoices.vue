<template>
  <div class="p-4 bg-bg-main min-h-full invoices-page">
    <PageHeader title="Hóa Đơn & Thanh Toán"
      ...
      <template #custom-actions>
        <button @click="goToBulkPage" class="inline-flex items-center px-2.5 py-1.5 sm:px-3 sm:py-1.5 text-[10px] sm:text-xs font-bold bg-white dark:bg-slate-900 border border-border-main rounded-lg text-text-main hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer gap-1.5 transition-all">
