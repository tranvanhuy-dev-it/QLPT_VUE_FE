  ...
  <div class="p-4 bg-bg-main min-h-full dashboard-page">
    ...
    <template v-else>
      ...
      <div class="bg-card border border-border-main rounded-2xl p-4 mb-4 shadow-xs flex flex-col gap-4">
        <!-- Date Selector Row -->
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border-main/50 pb-3">
            ...
            <tbody>
              <tr v-for="item in upcomingBillingContracts" :key="item.id"
                ...
                <td class="py-3 text-right">
                  <FormButton @click="navigateTo({ path: '/landlord/invoices', query: { createForContractId: item.id } })"
