    ...
    <template v-else>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 my-auto">
            <div @click="navigateTo('/landlord/boarding-houses')"
              ...
              <div
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                  stroke-width="2" class="w-5.5 h-5.5">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
      ...
      <div
        ...
        <div class="flex justify-between items-center mb-4 border-b border-border-main pb-3">
          <div class="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
              stroke-width="2" class="w-[18px] h-[18px] text-amber-500">
            ...
            <tbody>
              <tr v-for="item in upcomingBillingContracts" :key="item.id"
                ...
                <td class="py-3 text-right">
                  <button @click="navigateTo({ path: '/landlord/invoices', query: { createForContractId: item.id } })"
                    class="inline-flex items-center px-2.5 py-1 text-xs font-bold text-white bg-primary hover:bg-primary-hover rounded-lg cursor-pointer transition-all shadow-xs gap-1">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div
          ...
          <div class="flex justify-between items-center mb-4 border-b border-border-main pb-3">
            <div class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                stroke-width="2" class="w-[18px] h-[18px] text-primary">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
          ...
          <div class="flex justify-between items-center mb-4 border-b border-border-main pb-3">
            <div class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                stroke-width="2" class="w-[18px] h-[18px] text-danger">
                <path stroke-linecap="round" stroke-linejoin="round"
