<template>
  <div class="dashboard-page">
    <PageHeader 
      ...
      subtitle="Thống kê hoạt động kinh doanh phòng trọ" 
      :icon="dashboardIcon"
      :showSearch="false"
    />
    ...
    <div class="grid grid-cols-4" style="margin-bottom: 2rem;">
      <div class="card" style="margin-bottom: 0; display: flex; flex-direction: column; justify-content: space-between;">
        <span style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 700; letter-spacing: 0.05em;">DÃY TRỌ</span>
      ...
      <div class="card" style="margin-bottom: 0; display: flex; flex-direction: column; justify-content: space-between;">
        <span style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 700; letter-spacing: 0.05em;">TỔNG SỐ PHÒNG TRỌ</span>
      ...
      <div class="card" style="margin-bottom: 0; display: flex; flex-direction: column; justify-content: space-between;">
        <span style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 700; letter-spacing: 0.05em;">HỢP ĐỒNG HOẠT ĐỘNG</span>
      ...
      <div class="card" style="margin-bottom: 0; display: flex; flex-direction: column; justify-content: space-between;">
        <span style="font-size: 0.75rem; color: var(--text-secondary); font-weight: 700; letter-spacing: 0.05em;">HÓA ĐƠN CHƯA ĐÓNG</span>
