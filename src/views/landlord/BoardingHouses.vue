  ...
  <div class="app-container">
    ...
    <main class="main-content">
      <header style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
          <h1 style="font-weight: 700; font-size: 1.75rem;">Quản Lý Dãy Trọ</h1>
          <p style="color: var(--text-secondary);">Thêm mới và thiết lập đơn giá dịch vụ của từng khu nhà trọ</p>
        </div>
      ...
      <div v-else class="grid grid-cols-3">
        <div v-for="house in boardingHouses" :key="house.id" class="card" style="display: flex; flex-direction: column; justify-content: space-between;">
          <div>
        ...
        <div v-if="boardingHouses.length === 0" class="card" style="grid-column: span 3; text-align: center; padding: 3rem; color: var(--text-secondary);">
          Bạn chưa có dãy trọ nào. Hãy nhấn nút "Thêm Dãy Trọ Mới" ở góc trên bên phải để bắt đầu!
        </div>
      </div>
