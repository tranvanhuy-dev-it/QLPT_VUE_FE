  ...
  <div class="app-container">
    ...
    <main class="main-content">
      <header style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
          <h1 style="font-weight: 700; font-size: 1.75rem;">Hợp Đồng Thuê</h1>
          <p style="color: var(--text-secondary);">Quản lý hợp đồng cho thuê phòng, cấu hình phụ phí dịch vụ riêng biệt cho từng người ở</p>
        </div>
        <button @click="openAddModal" class="btn btn-primary" :disabled="vacantRooms.length === 0 || tenantsList.length === 0">
          + Tạo Hợp Đồng Mới
        </button>
      </header>
              ...
              <tbody>
                ...
                <tr v-if="contracts.length === 0">
                  <td colspan="9" style="text-align: center; color: var(--text-secondary); padding: 2rem;">
                    Chưa có hợp đồng nào được tạo. Nhấp "Tạo Hợp Đồng Mới" để bắt đầu!
                  </td>
                </tr>
              </tbody>
            </table>
