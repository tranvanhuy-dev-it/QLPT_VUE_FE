  ...
  <div class="app-container">
    ...
    <main class="main-content">
      <header style="margin-bottom: 2rem;">
        <h1 style="font-weight: 700; font-size: 1.75rem;">Thông Tin Phòng Trọ Của Tôi</h1>
        <p style="color: var(--text-secondary);">Xem chi tiết hợp đồng thuê, chỉ số điện nước và hóa đơn thanh toán hàng tháng</p>
      </header>
          ...
          <div class="grid grid-cols-3" style="margin-bottom: 2rem;">
            ...
            <div class="card" style="margin-bottom: 0;">
              ...
              <div style="font-size: 0.9rem; line-height: 1.75;">
                ...
                <div v-else>
                  <strong>Nước (cố định):</strong> 💧 Có định theo {{ activeContract.room.boardingHouse.waterBillingType === 'FIXED_PER_PERSON' ? 'người ở' : 'phòng' }}
                </div>
