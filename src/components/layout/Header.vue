  ...
  >
    ...
    <div class="flex items-center gap-2 sm:gap-4 shrink-0">
      ...
      <div class="relative profile-dropdown-container flex items-center border-l border-border-main pl-2 sm:pl-4">
        ...
        >
          <!-- Cài đặt tài khoản -->
          <button @click="navigateToSettings" class="w-full text-left px-4 py-2.5 text-text-main hover:bg-slate-50 dark:hover:bg-slate-800 transition cursor-pointer flex items-center gap-2">
          ...
          <!-- Liên hệ hỗ trợ -->
          <button @click="$router.push('/contact'); showDropdown = false" class="w-full text-left px-4 py-2.5 text-text-main hover:bg-slate-50 dark:hover:bg-slate-800 transition cursor-pointer flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 text-text-sub">
