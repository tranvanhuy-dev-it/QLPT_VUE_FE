...
const routes = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiresRole: 'LANDLORD', hideBottomBar: true, disableMainScroll: true },
  },
  {
    path: '/landlord/rooms',
    name: 'Rooms',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiresRole: 'TENANT', hideBottomBar: true, disableMainScroll: true },
  },
  {
    path: '/settings',
    name: 'Settings',
